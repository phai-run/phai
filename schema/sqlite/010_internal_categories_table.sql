...
INSERT OR IGNORE INTO internal_categories (category_id) VALUES ('credit-card-payment');
INSERT OR IGNORE INTO internal_categories (category_id) VALUES ('transfer-internal');

-- Recreate aggregate views using the reference table
