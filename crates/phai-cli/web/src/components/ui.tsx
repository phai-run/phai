...
export const ViewHeader = ({
  ...
  >
    {title}
    {count != null && (
      <span className="mono" style={{ color: accent, fontSize: '0.55em', fontWeight: 400 }}>
        {count}
      </span>
    )}
  </h2>
...
export const TextInput = (
  ...
  const { accent: _accent, style, ...rest } = props
  return <input {...rest} className="mono" style={{ ...fieldStyle, ...style }} />
}
...
export const Select = (
  ...
  return <select {...rest} className="mono" style={{ ...fieldStyle, ...style }} />
}
...
export const LoadingNote = ({ message = 'carregando…' }: { message?: string }) => (
